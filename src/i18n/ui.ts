...
const en = {
  ...
  work: {
    ...
    lead: "The problem, what I did about it and what changed.",
    allWork: "All work",
    projects: "projects",
  },
  caseUi: {
...
const nl: typeof en = {
  ...
  work: {
    ...
    lead: "Het probleem, wat ik eraan deed en wat er veranderde.",
    allWork: "Al het werk",
    projects: "projecten",
  },
  caseUi: {
...
const es: typeof en = {
  ...
  work: {
    heading: [
      { text: "Seis casos," },
      { br: true },
      { text: "contados sin adornos." },
    ] as Seg[],
    lead: "El problema, lo que hice y lo que cambió.",
